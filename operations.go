...
func (c *Config) Standard(currency string) (*StandardResponse, error) {
...
// We use ISO 4217 Three Letter Currency Codes - e.g. USD for US Dollars, EUR for Euro etc. Here are the :https://www.exchangerate-api.com/docs/supported-currencies
func (c *Config) PairConversion(fromCurrency, toCurrency string) (*PairConversionResponse, error) {
...
// We use ISO 4217 Three Letter Currency Codes - e.g. USD for US Dollars, EUR for Euro etc. Here are the :https://www.exchangerate-api.com/docs/supported-currencies
func (c *Config) EnrichedData(fromCurrency, toCurrency string) (*EnrichedDataResponse, error) {
...
func (c *Config) HistoricalDataBasicFormat(currency string, year, month, day int) (*HistoricalDataBasicFormatResponse, error) {
...
func (c *Config) HistoricalDataSpecificFormat(currency string, year, month, day int, amount float64) (*HistoricalDataSpecificFormat, error) {
